...
@WebServlet("/EditAdverFiles")
@MultipartConfig(
    fileSizeThreshold   = 1024 * 1024 * 1,  // 1 MB
    maxFileSize         = 1024 * 1024 * 10, // 10 MB
    maxRequestSize      = 1024 * 1024 * 15, // 15 MB
    location            = "D:/UploadAdvert")
public class EditAdver extends HttpServlet 
{
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
            ...
            try
            {
                ...
                PreparedStatement pst=con.prepareStatement("update advertisement set Place=?,FromDate=?,ToDate=?,Cost=?,Descrip=?,Image=? where Name=?");
