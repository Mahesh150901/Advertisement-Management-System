...
public class EditRetailer extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
            ...
            try
            {
                ...
                PreparedStatement pst=con.prepareStatement("update retailerlogin set Email=?,Phone=?,DOB=?,City=?,State=?,Country=?,Username=?,Password=?,Image=? where Name=?&&Gender=?");
                ...
                {
                    pw.println("Incorrect Employee Details");
                }
            }
            catch(Exception e)
            {
