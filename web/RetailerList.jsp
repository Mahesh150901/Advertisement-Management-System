    ...
    <body>
        ...
        <%
            try
            {
                ...
                PreparedStatement pst=con.prepareStatement("Select * from retailerlogin");
                ResultSet rs=pst.executeQuery();
                out.println("<h3 style='font-family:TimesNewRoman;font-size:30px;color:crimson'>Retailers Report</h3>");
                ...
                while(rs.next())
                {
                    ...
                    out.println("<tr><td style='border:1px solid black;border:collapse:collapse'>"+i+"</td>"
                            ...
                            + "<img src='http://localhost:8080/Advertisement/DisplayImage?Name="+Name+"' alt='"+Name+"' style='width:150px;height:120px'>");
                    out.println("</td><td style='border:1px solid black;border:collapse:collapse'>"+rs.getString("Name")+"</td>"
                            ...
                            + "<a href='EditRetailer.html'>Edit</a></span>"
                            + "<span style='padding-left:10px'>"
                            + "<a href='DelRetailer.html'>Delete</a>"
                            + "</span></td></tr>");
                    i++;
                }
                out.println("</table>");
