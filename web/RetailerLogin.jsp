...
<html>
    ...
    <body>
        ...
        try
        {
            ...
            PreparedStatement pst=con.prepareStatement("Select * from retailerlogin where Username=?");
            ...
            if(Password.equals(pass))
            {
             ...
             RequestDispatcher rd=request.getRequestDispatcher("RetailerHome.html");
