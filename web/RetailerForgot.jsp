    ...
    <body>
        <%
            ...
            try
            {
             ...
             PreparedStatement pst=con.prepareStatement("Select Name,Password from retailerlogin where Username=?");
             ...
             try
             {
                 ...
                 RequestDispatcher rd=request.getRequestDispatcher("RetailerForgot.html");
