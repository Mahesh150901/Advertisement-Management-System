    ...
    <body>
        <%
            ...
            try
            {
                ...
                if(i>0)
                {
                    pw.println("<h3 style='color:crimson;font-size:30px'>Feedback Recorded</h3>");
                    RequestDispatcher rd=request.getRequestDispatcher("RetailerFeedback.html");
                    rd.include(request, response);
                }
                else
                {
                   pw.println("<h3 style='color:crimson;font-size:30px'>Failed to record Feedback</h3>");
                   RequestDispatcher rd=request.getRequestDispatcher("RetailerFeedback.html");
                   rd.include(request, response); 
                }
            }
