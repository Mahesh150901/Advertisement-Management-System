    ...
    <body>
        <%
            ...
            try
            {
             ...
             PreparedStatement pst=con.prepareStatement("Select Name,Password from consumerlogin where Username=?");
             ...
             try
             {
                 ...
                 RequestDispatcher rd=request.getRequestDispatcher("ConsumerForgot.html");
